...
router.get('/getenableassignments', auth.isSignedIn, catchErrors(webController.getEnableAssignments))
router.get('/getdisableassignments', auth.isSignedIn, catchErrors(webController.getDisableAssignments))
...
router.put('/disableassignments', auth.isSignedIn, catchErrors(webController.disableAssignments))
router.put('/enableassignments', auth.isSignedIn, catchErrors(webController.enableAssignments))
