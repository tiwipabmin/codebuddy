...
exports.updateAssignment = async (req, res) => {
  ...
  const title = (req.body.title).replace(/<br><br>/g, "\\n");
  ...
  const description = (req.body.description).replace(/<br><br>/g, "\\n");
  const input_specification = (req.body.input_specification).replace(/<br><br>/g, "\\n");
  const output_specification = (req.body.output_specification).replace(/<br><br>/g, "\\n");
  const sample_input = (req.body.sample_input).replace(/<br><br>/g, "\\n");
  const sample_output = (req.body.sample_output).replace(/<br><br>/g, "\\n");
